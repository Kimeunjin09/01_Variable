...
public class VariableExample2 {
	public static void main (String[] args) {
		...
		// 자료형 변수명 = 리터럴;
		// 프로그래밍에서는 대입되는 데이터를 리터럴라는 단어로도 표현
		...
		char ch = 'A'; //65
		char ch2 = 66; //B
		//String str = "gdsg" // String은 무조건 " "써주기
		 ...
		 * 'B' 문자 그대로가 대입되면 변수에 숫자66으로 변환되서 저장
		 * --> 반대로 생각하면 변수에 애초에 66이라는 숫자를 저장하는것이 가능하다. 
		 * */
		
		// 변수 명명 규칙
		// 1. 대소문자 구분O, 길이제한 X
		 int agskdlgjwepjgdsvgsdgsdgwegdsgsdhdfhfdh;
		 int agskdlgjwepjgdsvgsdgsdgwegdsgsdhdfhfdH;
		
		// 2. 예약어 사용 X
		// float double; // double은 예약어
		 
		 // 3. 숫자 시작 X
		 // Char 1abc;
		 
		 // 4. 특수문자 _ , $ 만 사용가능 (하지만 쓰지 않는다)
		 int $intNumber; // 문젠ㄴ 없지만 개발자가 직접 사용 안합니다.
		  ...
		  * -자료형 앞에 final 키워드를 작성(마지막 대입되는 값이라는 뜻으로)
		  * 
